...
class Poster {
  ...
  render() {
    ...
    const postsList = posts.map((post, index) => {
      return `
        <div class="portfolio__project project-card ${post.className}" data-tabson="wrapper">
            ...
            <div class="portfolio__project-image">
              <div class="portfolio__project-images" data-tabson="items">
                <!-- <a href="#${post.title}" data-effect="mfp-zoom-in" data-post="${index}" data-popup="desc" class="portfolio__project-img open popup"
                  data-item="1" data-lazy="${post.srcDesc}" style="background-image: url('${post.srcDesc}');"></a>
                <a href="#${post.title}-mobile" data-effect="mfp-zoom-in" data-post="${index}" data-popup="mobile" class="portfolio__project-img popup"
                  data-item="2" data-lazy="${post.srcMobile}" style="background-image: url('${post.srcMobile}');"></a>
                  -->
...
$(function () {
  ...
  $('[data-control="portfolio"]').on('click', () => {
    $('.portfolio__inner').css({
      opacity: '0',
  ...
  mixitup('.portfolio', {
    ...
    selectors: {
      control: '[data-control="portfolio"]',
      target: '.project-card'
    }
  })
})
